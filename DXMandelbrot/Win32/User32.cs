...
{
    public static short Loword(IntPtr param) => (short)((long)param & 0x0000FFFF);
    public static short Hiword(IntPtr param) => (short)((long)param >> 16);
}
